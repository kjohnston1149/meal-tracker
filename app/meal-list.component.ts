...
@Component({
  ...
  <h1>My Meals</h1>
    ...
    <!--Display tasks-->
    <div *ngFor="let currentMeal of childMealList | calories:selectedCalorieDisplay" class="well" id="subWell">
    ...
    <button (click)="editButtonHasBeenClicked(currentMeal)" class="btn btn-default" data-toggle="modal" data-target="#myModal">Edit</button>
    </div>
  </div>
  `
})
